...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT(
        KC_ESC,              DE_0,    DE_2,    DE_3,    DE_4,    DE_5,    DE_6,    DE_7,    DE_8,    DE_9,    DE_0,    DE_MINS, DE_EQL,  KC_BSPC, KC_INS,
        ...
        OSM(KC_LSFT),                 DE_X,    DE_V,    DE_G,    DE_M,    DE_K,    DE_ADIA, DE_UDIA, DE_SS,   DE_COMM, DE_DOT,  KC_RSFT, KC_UP,   KC_PGDN,
        OSM(KC_LCTL),        OSM(KC_LGUI), OSM(KC_LALT),         KC_SPC,                             KC_RALT, MO(1),            KC_LEFT, KC_DOWN, KC_RGHT
    ),
    LAYOUT(
